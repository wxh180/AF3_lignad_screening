...
def _load_freesasa():
    ...
    try:
        ...
        raise PipelineError(
            "FreeSASA is required for SASA analysis in v2.2.2; install "
...
def _sasa_backend_description() -> str:
    return f"FreeSASA {_sasa_backend_version()}; 1 thread/worker"
...
def calculate_buried_sasa(
    ...
    """Calculate buried SASA with compiled FreeSASA Shrake-Rupley."""
    freesasa = _load_freesasa()
